 ...
 */
var DuplexMock = function (_Duplex) {
  (0, _inherits3.default)(DuplexMock, _Duplex);

  function DuplexMock(options) {
    (0, _classCallCheck3.default)(this, DuplexMock);
     ...
     */
    var _this = (0, _possibleConstructorReturn3.default)(this, (DuplexMock.__proto__ || (0, _getPrototypeOf2.default)(DuplexMock)).call(this, options));
  ...
  (0, _createClass3.default)(DuplexMock, [{
    key: '_read',
    value: function _read() {
      if (this.data.length === 0) {
        ...
        var buf = Buffer.from(this.data.shift().toString(), this._readableState.encoding);
        this.push(buf);
      }
    }
